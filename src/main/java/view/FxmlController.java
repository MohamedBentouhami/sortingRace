...
public class FxmlController {
    ...
    private TableColumn<?, ?> hSortType;
    private TableColumn<?, ?> hSizeCol;
    private TableColumn<?, ?> hDate;
    private ObservableList<LogsDto> history;
    ...
    public void initializeTableHistory() {
        hDate = new TableColumn<>();
        hSortType = new TableColumn<>();
        hSizeCol = new TableColumn<>();
        historyTable = new TableView<LogsDto>();
        hDate.setCellValueFactory(new PropertyValueFactory<>("type"));
        hSortType.setCellValueFactory(new PropertyValueFactory<>("duration"));
        hSizeCol.setCellValueFactory(new PropertyValueFactory<>("pas"));
    ...
    @FXML
    public void historyWindow() throws IOException {
    ...
    public void setHistory(List<LogsDto> args) {
